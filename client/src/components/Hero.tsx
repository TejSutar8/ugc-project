...
export default function Hero() {
    ...
    const galleryStripImages = [
        'https://images.unsplash.com/photo-1545239351-1141bd82e8a6?w=80&w=100',
        'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=80&w=100',
        'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=80&w=100',
    ];
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Upload product images and a model photos - our AI instantly produces professional lifestyle imagery and short-form videos optimized for commercial & Reels
                            </motion.p>
